...
int add(DoublyLinkedList *list, int pos, void *data) {
    log_info("Inserindo um dado em uma posicao da lista");
    log_trace("add ->");
...
int addAll(DoublyLinkedList *listDest, int pos, DoublyLinkedList *listSource) {
    log_info("Adicionando uma lista dentro de outra");
    log_trace("addALL ->");
...
void show(DoublyLinkedList *list, printNode print) {
    log_info("Exibindo todos os dados em ordem");
    log_trace("show ->");
    Node *aux = list->first->next;
...
void showMem(DoublyLinkedList *list) {
    log_info("Exibindo a estrutura em memoria");
    log_trace("showMem ->");
    printf("Trash Node: %p\n\n",list->first);
    Node *aux = list->first->next;
